...
def recommend_portfolio(intent_request):
    ...
    source = intent_request["invocationSource"]
        ...
        # Validate age
    age = parse_int(age)
    if age is None or age < 0 or age >= 65:
        return build_validation_result(
            False,
            "age",
            "Your age should be a whole number between 0 and 64."
        )

    # Validate investment amount
    investment_amount = parse_int(investment_amount)
    if investment_amount is None or investment_amount < 5000:
        return build_validation_result(
            False,
            "investmentAmount",
            "The minimum investment amount is $5000. Please provide a valid amount."
        )

    # Recommendation logic based on risk level
    if risk_level == "none":
        ...
        recommendation = "I'm sorry, I couldn't determine an appropriate recommendation based on the provided information."
    ...
    response = {
        ...
        "dialogAction": {
            ...
            "message": {
                ...
                "content": f"Thank you for providing the information, {first_name}. Based on your risk level '{risk_level}', my recommendation for your investment portfolio is: {recommendation}"
            }
        }
    }
